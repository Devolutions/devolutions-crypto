...
class TestComformity(unittest.TestCase):
    def test_derive_pbkdf2(self):
        self.assertEqual(devolutions_crypto.derive_key_pbkdf2(b'testpassword', None), b64decode(b'wdU+cxAOpTFddVhTQlKQTSzmVjZqPAXVx1cRrAqTGek='))
    ...
    def test_decrypt_v1_with_aad(self):
        ...
        self.assertEqual(devolutions_crypto.decrypt_with_aad(ciphertext, key, aad), b'test Ciph3rtext~')
    ...
    def test_asymmetric_v2_with_aad(self):
        ...
        self.assertEqual(devolutions_crypto.decrypt_asymmetric_with_aad(ciphertext, private_key, aad), b"testdata")
