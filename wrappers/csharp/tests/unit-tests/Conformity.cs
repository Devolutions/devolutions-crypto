    ...
    public class Conformity
    {
        ...
        public void DecryptAsymmetricV2()
        {
            byte[]? decryptResult = Managed.DecryptAsymmetric(
                Utils.Base64StringToByteArray(
                    "DQwCAAIAAgCIG9L2MTiumytn7H/p5I3aGVdhV3WUL4i8nIeMWIJ1YRbNQ6lEiQDAyfYhbs6gg1cD7+5Ft2Q5cm7ArsGfiFYWnscm1y7a8tAGfjFFTonzrg=="),
        ...
        {
            Argon2Parameters? parameters = Argon2Parameters.FromByteArray(
                Utils.Base64StringToByteArray("AQAAACAAAAABAAAAIAAAAAEAAAACEwAAAAAQAAAAimFBkm3f8+f+YfLRnF5OoQ==")!);
        ...
        public void SignatureV1()
        {
            ...
            byte[] wrongData = Encoding.UTF8.GetBytes("this is wrong");

            SigningPublicKey publicKey =
                SigningPublicKey.FromByteArray(
                    Convert.FromBase64String("DQwFAAIAAQDeEvwlEigK5AXoTorhmlKP6+mbiUU2rYrVQ25JQ5xang=="));
        ...
        [TestMethod]
        public void DeriveDecryptWithPassword_V1()
        {
            byte[] data = Utils.Base64StringToByteArray(
                ...
                !;
            byte[] password = Utils.StringToUtf8ByteArray("DevoCrypto!");
            byte[]? result = Managed.DeriveDecryptWithPassword(data, password);
            Assert.AreEqual("Derive and Encrypt", Utils.ByteArrayToUtf8String(result));
        }
    }
}
