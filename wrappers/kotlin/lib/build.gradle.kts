...
kotlin {
    jvm() // Java support (JAR)
    androidTarget() // Android support (AAR)
...
publishing {
    ...
    publications {
        ...
        create<MavenPublication>("mavenAndroid") {
            groupId = "devolutions"
            artifactId = "devolutions-crypto-android" // Separate artifact ID for Android
            version = project.version.toString()
            from(components["release"]) // Android Component
