...
//!
//! let hashed_password = hash_password(password, 600000, PasswordHashVersion::Latest).expect("hash password shoudln't fail");;
//!
...
///    A higher number is slower but harder to brute-force (defaults to 600,000)
