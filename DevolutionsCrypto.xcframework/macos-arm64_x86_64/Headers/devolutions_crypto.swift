...
public protocol Argon2ParametersProtocol : AnyObject {
    
    func getBytes()  -> Data
    
}

open class Argon2Parameters:
    Argon2ParametersProtocol {
...
public static func newFromBytes(data: Data)throws  -> Argon2Parameters {
    return try  FfiConverterTypeArgon2Parameters.lift(try rustCallWithError(FfiConverterTypeDevolutionsCryptoError.lift) {
...
public protocol Argon2ParametersBuilderProtocol : AnyObject {
...
open class Argon2ParametersBuilder:
    Argon2ParametersBuilderProtocol {
    fileprivate let pointer: UnsafeMutableRawPointer!
...
open func associatedData(value: Data) -> Argon2ParametersBuilder {
    return try!  FfiConverterTypeArgon2ParametersBuilder.lift(try! rustCall() {
...
open func build() -> Argon2Parameters {
    return try!  FfiConverterTypeArgon2Parameters.lift(try! rustCall() {
...
open func variant(value: Argon2Variant) -> Argon2ParametersBuilder {
    ...
    uniffi_devolutions_crypto_uniffi_fn_method_argon2parametersbuilder_variant(self.uniffiClonePointer(),
        FfiConverterTypeArgon2Variant.lower(value),$0
    )
})
}
...
open func version(value: Argon2Version) -> Argon2ParametersBuilder {
    ...
    uniffi_devolutions_crypto_uniffi_fn_method_argon2parametersbuilder_version(self.uniffiClonePointer(),
        FfiConverterTypeArgon2Version.lower(value),$0
    )
})
}
...
public protocol SigningKeyPairProtocol : AnyObject {
...
open class SigningKeyPair:
    SigningKeyPairProtocol {
    fileprivate let pointer: UnsafeMutableRawPointer!
...
public static func newFromBytes(data: Data)throws  -> SigningKeyPair {
    return try  FfiConverterTypeSigningKeyPair.lift(try rustCallWithError(FfiConverterTypeDevolutionsCryptoError.lift) {
...
public enum DevolutionsCryptoError {
...
public func encrypt(data: Data, key: Data, version: CiphertextVersion = .latest)throws  -> Data {
    return try  FfiConverterData.lift(try rustCallWithError(FfiConverterTypeDevolutionsCryptoError.lift) {
    uniffi_devolutions_crypto_uniffi_fn_func_encrypt(
        FfiConverterData.lower(data),
        FfiConverterData.lower(key),
        FfiConverterTypeCiphertextVersion.lower(version),$0
    )
})
}
...
public func generateKeypair(version: KeyVersion = .latest) -> KeyPair {
    ...
    uniffi_devolutions_crypto_uniffi_fn_func_generate_keypair(
        FfiConverterTypeKeyVersion.lower(version),$0
    )
})
}
public func generateSharedKey(nShares: UInt8, threshold: UInt8, length: UInt32 = UInt32(32), version: SecretSharingVersion = .latest)throws  -> [Data] {
    return try  FfiConverterSequenceData.lift(try rustCallWithError(FfiConverterTypeDevolutionsCryptoError.lift) {
    uniffi_devolutions_crypto_uniffi_fn_func_generate_shared_key(
        ...
        FfiConverterTypeSecretSharingVersion.lower(version),$0
    )
})
}
public func generateSigningKeypair(version: SigningKeyVersion = .latest) -> SigningKeyPair {
    return try!  FfiConverterTypeSigningKeyPair.lift(try! rustCall() {
    uniffi_devolutions_crypto_uniffi_fn_func_generate_signing_keypair(
        FfiConverterTypeSigningKeyVersion.lower(version),$0
    )
})
}
public func hashPassword(password: Data, iterations: UInt32 = UInt32(10000), version: PasswordHashVersion = .latest) -> Data {
    return try!  FfiConverterData.lift(try! rustCall() {
    uniffi_devolutions_crypto_uniffi_fn_func_hash_password(
        FfiConverterData.lower(password),
        FfiConverterUInt32.lower(iterations),
        FfiConverterTypePasswordHashVersion.lower(version),$0
    )
})
}
public func sign(data: Data, keypair: Data, version: SignatureVersion = .latest)throws  -> Data {
    ...
    uniffi_devolutions_crypto_uniffi_fn_func_sign(
        ...
        FfiConverterTypeSignatureVersion.lower(version),$0
    )
})
}
...
public func deriveKeyArgon2(key: Data, parameters: Argon2Parameters)throws  -> Data {
    ...
    uniffi_devolutions_crypto_uniffi_fn_func_derive_key_argon2(
        FfiConverterData.lower(key),
        FfiConverterTypeArgon2Parameters.lower(parameters),$0
    )
})
}
...
public func generateKey(length: UInt32 = UInt32(32)) -> Data {
    return try!  FfiConverterData.lift(try! rustCall() {
...
public func validateHeader(data: Data, dataType: DataType) -> Bool {
    ...
    uniffi_devolutions_crypto_uniffi_fn_func_validate_header(
        FfiConverterData.lower(data),
        FfiConverterTypeDataType.lower(dataType),$0
    )
})
}
public func verifyPassword(password: Data, hash: Data)throws  -> Bool {
    return try  FfiConverterBool.lift(try rustCallWithError(FfiConverterTypeDevolutionsCryptoError.lift) {
...
private var initializationResult: InitializationResult = {
    ...
    if (uniffi_devolutions_crypto_uniffi_checksum_func_hash_password() != 62085) {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if (uniffi_devolutions_crypto_uniffi_checksum_func_generate_key() != 42956) {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if (uniffi_devolutions_crypto_uniffi_checksum_constructor_argon2parameters_new_from_bytes() != 48784) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_devolutions_crypto_uniffi_checksum_constructor_argon2parametersbuilder_new() != 58740) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_devolutions_crypto_uniffi_checksum_constructor_signingkeypair_new_from_bytes() != 42998) {
        return InitializationResult.apiChecksumMismatch
    }
